...
\smash{\raisebox{-0.41\height\hspace{-180pt}}{\includegraphics[scale=0.67, bottom]{photo.png}}}
...
{}
{Collaborator: Exponential Roadmap Initiative, IKEA, Finnish Innovation Fund, Mission 2020}
%------------------------------------------------
\entry
{\small{2017}}
...
{The World in 2050}
{}
{Collaborator: Sustainable Development Solutions Network (SDSN), International Institute for Applied Systems Analysis (IIASA)}
%------------------------------------------------
\end{entrylist}
\section{}
\begin{entrylist}
